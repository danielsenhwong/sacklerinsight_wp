			...
			if(isset($instance['type']) && $instance['type'] == 'Set')
			{
				...
				if(isset($instance['photoselect']) && $instance['photoselect'] == 'Random')
				{
					...
					for($i = 0; $i < $instance['photocnt']; $i++){
						...
						$store['photos'][$i]['flickr'] = 'http://www.flickr.com/photos/' . $data['photoset']['owner'] . '/' . $data['photoset']['photo'][$gen[$i]]['id'];
			...
			else
			{
				...
				if($instance['photoselect'] == 'Random')
				{
					...
					for($i = 0; $i < $instance['photocnt']; $i++)
					{
						...
						$store['photos'][$i]['flickr'] = 'http://www.flickr.com/photos/' . $data['photos']['photo'][$gen[$i]]['owner'] . '/' . $data['photos']['photo'][$gen[$i]]['id'];
