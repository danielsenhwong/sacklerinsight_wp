...
if(!class_exists('fsAdmin'))
{
    ...
    class fsAdmin
    {
        ...
        public function addStyles()
        {
            ...
            wp_enqueue_style('fs-admin-css', plugins_url('css/admin.min.css', __FILE__), false, $this->_version);
        ...
        public function option_panel()
        {
            ...
            require(dirname(__FILE__) . '/inc/forms/generalOptions.inc.php');
        ...
        public function shortcode_panel()
        {
            ...
            if(isset($_GET['view']))
            {
                ...
                if($_GET['view'] == 'shortcodecreate')
                    require(dirname(__FILE__) . '/inc/forms/createShortcode.inc.php');
                elseif($_GET['view'] == 'shortcodeedit')
                    require(dirname(__FILE__) . '/inc/forms/editShortcode.inc.php');

            }
            //display shortcodes
            else
                require(dirname(__FILE__) . '/inc/forms/overviewShortcodes.inc.php');
            ?>
        ...
        public function processor()
        {
            ...
            require(dirname(__FILE__) . '/inc/processor.inc.php');
